...
namespace tcomp1.Migrations
{
    ...
    [Migration("20230330025149_mr30-3p3")]
    partial class mr303p3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdemicIdea", b =>
                {
                    b.Property<string>("AdemicsIdAdemic")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("IdeasId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AdemicsIdAdemic", "IdeasId");

                    b.HasIndex("IdeasId");

                    b.ToTable("AdemicIdea");
                });
            ...
            modelBuilder.Entity("AdemicIdea", b =>
                {
                    b.HasOne("tcomp1.Models.Ademic", null)
                        .WithMany()
                        .HasForeignKey("AdemicsIdAdemic")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("tcomp1.Models.Idea", null)
                        .WithMany()
